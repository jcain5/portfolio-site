      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="grid sm:grid-cols-4 gap-4 mb-10">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex flex-col items-center gap-3 p-6 rounded-xl bg-[#0a0f1e] border border-slate-800 hover:border-slate-500/60 transition-all hover:-translate-y-0.5"
          >
